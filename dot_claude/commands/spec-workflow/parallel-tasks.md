...
6. Validate agent availability and capabilities
7. Match requested agents to available tasks
8. Warn if agent-task mismatch detected
9. Proceed with user-specified assignments
