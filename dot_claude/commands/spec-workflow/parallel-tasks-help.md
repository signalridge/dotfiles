...
_Deploys implementation, testing, and documentation agents_
...
_Parallel bug fixing across different components_
...
_Coordinates deployment scripts, performance validation, release notes_
