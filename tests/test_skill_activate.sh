...
assert_contains "$help_output" "current directory: ./.claude/skills/ + ./.codex/skills/ + ./.pi/skills/ + ./.cursor/skills/ + ./.kimi-code/skills/"
...
assert_symlink_to "$PROJECT_DIR/.kimi-code/skills/ts-one" "$LIBRARY/typescript/ts-one"
assert_symlink_to "$PROJECT_DIR/.kimi-code/skills/ts-two" "$LIBRARY/typescript/ts-two"
...
assert_missing "$PROJECT_DIR/.kimi-code/skills/py-one"
...
assert_symlink_to "$PROJECT_DIR/.kimi-code/skills/py-one" "$LIBRARY/python/py-one"
...
assert_symlink_to "$PARTIAL_DIR/.kimi-code/skills/ts-one" "$LIBRARY/typescript/ts-one"
assert_missing "$HOME_DIR/.claude/skills/ts-one"
assert_missing "$HOME_DIR/.codex/skills/ts-one"
...
assert_symlink_to "$PARTIAL_CATEGORY_DIR/.kimi-code/skills/ts-one" "$LIBRARY/typescript/ts-one"
assert_symlink_to "$PARTIAL_CATEGORY_DIR/.kimi-code/skills/ts-two" "$LIBRARY/typescript/ts-two"
...
assert_missing "$PROJECT_DIR/.kimi-code/skills/ts-one"
assert_missing "$PROJECT_DIR/.kimi-code/skills/ts-two"
...
assert_not_symlink "$CLEAR_DIR/.kimi-code/skills/ts-one"
