...
bash "$ROOT/tests/test_repository_invariants.sh"
...
bash "$ROOT/tests/test_profile_alignment.sh"
bash "$ROOT/tests/test_cursor_agent_install.sh"
bash "$ROOT/tests/test_run_onchange_source_hashes.sh"
...
bash "$ROOT/tests/test_toolchain_bootstrap.sh"
bash "$ROOT/tests/test_skill_library.sh"
...
node --experimental-strip-types "$ROOT/tests/test_pi_early_compaction.mjs"
node --experimental-strip-types "$ROOT/tests/test_pi_gpt_routes.mjs"
