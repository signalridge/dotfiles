---
# Ejected built-in `general-purpose`, model pinned per user request (2026-07-15): runs
# openai-codex/gpt-5.6-sol (native Codex OAuth, off the krill gateway — same swap as the
# parent default) and must NOT inherit the parent session's /model
