---
# Ejected built-in `general-purpose`, model pinned per user request (2026-07-26): runs
# krill/gpt-5.6-sol, matching the parent default, and must NOT inherit later parent
