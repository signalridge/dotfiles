...
# (2026-07-15): routed through openai-codex/gpt-5.6-sol (native Codex OAuth, off the krill
# gateway — same swap as the parent default), NOT inheriting the parent /model.
